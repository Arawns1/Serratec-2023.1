...
public class SistemaPrincipal {
	...
	public static void main(String[] args) {
		...
		////Funcionario f = new Diretor("Gabriel", "Damico", "12221212", "222222222", "gabriel@gmail.com", 1234, 1000.0,
		////		2);
		...
		////System.out.println(
		////		"O salário com bonificação de " + f.getNome() + " é : R$" + FolhaPagamento.calculaFolhaPagamento(f));
		////System.out.println("-".repeat(40));
		////System.out.println(); // pular linha

		// f.autentica() -> não funciona pois a classe Funcionário não possui este
		// método
		...
		// Assim como APENAS Diretores podem ver o número de contas e funcionarios do
		// banco
