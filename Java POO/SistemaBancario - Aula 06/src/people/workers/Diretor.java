...
public class Diretor extends Gerente implements ItotalContas, ITotalFuncionarios {
	...
	public Diretor(String nome, String sobrenome, String cPF, String telefone, String email, double salario,
			int matricula, int senha) {
		super(nome, sobrenome, cPF, telefone, email, salario, matricula, senha);
	}
